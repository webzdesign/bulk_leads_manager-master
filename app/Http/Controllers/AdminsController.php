        ...
        return DataTables::eloquent($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if(auth()->user()->allowCreateEditUser == 1)
                    {
                        ...
                        $actions .= '<div class="editDlbtn d-flex"> <a href="javascript:void(0)"> <button class="cartBtn w-auto px-3 text-white f-500" style="background: orange;"> Permission Not Allow </button> </a>';
                    }
                    return $actions;
                })
