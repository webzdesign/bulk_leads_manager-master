                        ...
                        <div class="cards">
                            <table id="example" class="table" style="width:100%">
                                    ...
                                    <tr>
                                        <th>
                                            <label class="form-check-label mb-0" for="lbl1">
                                                <input class="form-check-input mt-0" type="checkbox" id="lbl1"/>
                                            </label>
                                        </th>
                                        <th>age</th>
                                        <th>email</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <label class="form-check-label mb-0" for="lbl2">
                                                <input class="form-check-input mt-0" type="checkbox" id="lbl2"/>
                                            </label>
                                        </td>
                                        <td class="c-e9">345 D</td>
                                        <td class="c-16">john@gmail.com</td>
                                        <td class="c-7b">Roland</td>
                                        <td class="c-7b">Johnson</td>
                                        <td class="c-7b">M</td>
                                        <td class="c-7b">45454556842</td>
                                        <td class="c-7b">22654</td>
                                        <td class="c-7b">AL</td>
                                        <td class="c-7b">48 Lower River Street Teaneck, NJ 07666</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label class="form-check-label mb-0" for="lbl2">
                                        ...
                                        <td class="c-e9 whiteSpace">345 D</td>
                                        <td class="c-16">john@gmail.com</td>
                                        <td class="c-7b">Roland</td>
                                        <td class="c-7b">Johnson</td>
                                        <td class="c-7b">M</td>
