            ...
            <div class="button-dropdown position-relative">
                ...
                <ul class="dropdown-menu settingWrpr cards filterDropdownBx p-0 m-0">
                    ...
                    <div class="py-3 cardsFooter d-flex justify-content-end">
                        <button type="button" class="btn-pink f-500 f-14" style="min-width: 84px !important;" id="clear">Clear</button>
                        <button type="button" class="btn-pink f-500 f-14" style="min-width: 84px !important;" id="apply">Apply</button>
                    </div>
                </ul>
            <div>
        </div>
