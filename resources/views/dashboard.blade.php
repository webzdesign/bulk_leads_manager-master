                ...
                <div class="col-md-6 mb-5">
                    <div class="statsCard">
                        <a href="{{ route('admin.new-order') }}"
                            class="cardTop w-auto d-flex align-items-center justify-content-center">
                            <svg class="me-2" width="15" height="15" viewBox="0 0 15 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M12 12C11.1675 12 10.5 12.6675 10.5 13.5C10.5 13.8978 10.658 14.2794 10.9393 14.5607C11.2206 14.842 11.6022 15 12 15C12.3978 15 12.7794 14.842 13.0607 14.5607C13.342 14.2794 13.5 13.8978 13.5 13.5C13.5 12.6675 12.825 12 12 12ZM0 0V1.5H1.5L4.2 7.1925L3.18 9.03C3.0675 9.24 3 9.4875 3 9.75C3 10.1478 3.15804 10.5294 3.43934 10.8107C3.72064 11.092 4.10218 11.25 4.5 11.25H13.5V9.75H4.815C4.76527 9.75 4.71758 9.73025 4.68242 9.69508C4.64725 9.65992 4.6275 9.61223 4.6275 9.5625C4.6275 9.525 4.635 9.495 4.65 9.4725L5.325 8.25H10.9125C11.475 8.25 11.97 7.935 12.225 7.4775L14.91 2.625C14.9625 2.505 15 2.3775 15 2.25C15 2.05109 14.921 1.86032 14.7803 1.71967C14.6397 1.57902 14.4489 1.5 14.25 1.5H3.1575L2.4525 0H0ZM4.5 12C3.6675 12 3 12.6675 3 13.5C3 13.8978 3.15804 14.2794 3.43934 14.5607C3.72064 14.842 4.10218 15 4.5 15C4.89782 15 5.27936 14.842 5.56066 14.5607C5.84196 14.2794 6 13.8978 6 13.5C6 12.6675 5.325 12 4.5 12Z"
                                    fill="#F8F9FA" />
                            </svg>
                            ...
                            <div class="cards pt-0 mb-0 position-relative">
                                <div class="cardTop w-auto d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <svg class="me-2" width="18" height="19" viewBox="0 0 18 19" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M12.75 14C11.9175 14 11.25 14.6675 11.25 15.5C11.25 15.8978 11.408 16.2794 11.6893 16.5607C11.9706 16.842 12.3522 17 12.75 17C13.1478 17 13.5294 16.842 13.8107 16.5607C14.092 16.2794 14.25 15.8978 14.25 15.5C14.25 14.6675 13.575 14 12.75 14ZM0.75 2V3.5H2.25L4.95 9.1925L3.93 11.03C3.8175 11.24 3.75 11.4875 3.75 11.75C3.75 12.1478 3.90804 12.5294 4.18934 12.8107C4.47064 13.092 4.85218 13.25 5.25 13.25H14.25V11.75H5.565C5.51527 11.75 5.46758 11.7302 5.43242 11.6951C5.39725 11.6599 5.3775 11.6122 5.3775 11.5625C5.3775 11.525 5.385 11.495 5.4 11.4725L6.075 10.25H11.6625C12.225 10.25 12.72 9.935 12.975 9.4775L15.66 4.625C15.7125 4.505 15.75 4.3775 15.75 4.25C15.75 4.05109 15.671 3.86032 15.5303 3.71967C15.3897 3.57902 15.1989 3.5 15 3.5H3.9075L3.2025 2H0.75ZM5.25 14C4.4175 14 3.75 14.6675 3.75 15.5C3.75 15.8978 3.90804 16.2794 4.18934 16.5607C4.47064 16.842 4.85218 17 5.25 17C5.64782 17 6.02936 16.842 6.31066 16.5607C6.59196 16.2794 6.75 15.8978 6.75 15.5C6.75 14.6675 6.075 14 5.25 14Z"
                                                fill="white" />
                                        </svg>
                                ...
                                <div class="cardYearList">
                                                ...
                                                @foreach ($orders as $order)
                                                    <tr>
                                                        <td class="c-7b f-16 whiteSpace">
                                                            ...
                                                            <svg class="ms-2" width="16" height="16"
                                                                viewBox="0 0 16 16" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M8.25 2.75H2.75V13.25H13.25V7.75M13.25 2.75L7.75 8.25M10.75 1.75H14.25V5.25"
                                                                    stroke="#4F4F52" stroke-width="1.5"
                                    ...
                                    <div class="mt-2 cursor-pointer d-flex align-items-center justify-content-center c-46 f-16 f-700"
                                        id='moreOrder'>
                                        LOAD MORE
                                        <svg class="ms-2" width="17" height="10" viewBox="0 0 17 10"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.16675 1.25L8.50008 8.58333L15.8334 1.25" stroke="#46679D"
                    ...
                    <div class="col-12">
                        <div class="statsCard">
                            <div class="cards pt-0 mb-0 position-relative">
                                <div class="cardTop w-auto d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <svg class="me-2" width="18" height="19" viewBox="0 0 18 19"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M12.75 14C11.9175 14 11.25 14.6675 11.25 15.5C11.25 15.8978 11.408 16.2794 11.6893 16.5607C11.9706 16.842 12.3522 17 12.75 17C13.1478 17 13.5294 16.842 13.8107 16.5607C14.092 16.2794 14.25 15.8978 14.25 15.5C14.25 14.6675 13.575 14 12.75 14ZM0.75 2V3.5H2.25L4.95 9.1925L3.93 11.03C3.8175 11.24 3.75 11.4875 3.75 11.75C3.75 12.1478 3.90804 12.5294 4.18934 12.8107C4.47064 13.092 4.85218 13.25 5.25 13.25H14.25V11.75H5.565C5.51527 11.75 5.46758 11.7302 5.43242 11.6951C5.39725 11.6599 5.3775 11.6122 5.3775 11.5625C5.3775 11.525 5.385 11.495 5.4 11.4725L6.075 10.25H11.6625C12.225 10.25 12.72 9.935 12.975 9.4775L15.66 4.625C15.7125 4.505 15.75 4.3775 15.75 4.25C15.75 4.05109 15.671 3.86032 15.5303 3.71967C15.3897 3.57902 15.1989 3.5 15 3.5H3.9075L3.2025 2H0.75ZM5.25 14C4.4175 14 3.75 14.6675 3.75 15.5C3.75 15.8978 3.90804 16.2794 4.18934 16.5607C4.47064 16.842 4.85218 17 5.25 17C5.64782 17 6.02936 16.842 6.31066 16.5607C6.59196 16.2794 6.75 15.8978 6.75 15.5C6.75 14.6675 6.075 14 5.25 14Z"
                                                fill="white" />
                                                ...
                                                @if ($Allleads)
                                                    @foreach ($Allleads as $lead)
                                                        <tr>
                                                            ...
                                                            <td class="c-7b f-16">
                                                                @if ($lead->age_group)
                                                                    {{ $lead->age_group->age_from }}-{{ $lead->age_group->age_to }}
                                                                    Days Old
                                                                @endif
                                                            </td>
